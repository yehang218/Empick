...
지원자 입장의 사이트, 지원서/지원자, 자기소개서 관련 도메인에서 crud 기능 구현
프론트 ui 제작과 연동

#### 잘한 점

- join이 여러번 일어나는 복잡한 도메인 구조를 이해하게 됨됨

#### 아쉬운 점

- 마감 기한을 지키지 잘 지키지 못한 점

#### 배운 점

- 프로젝트를 거듭 지나오며 얻어가는 향상된 코딩 실력
...
- 개발 초기에 코드의 유지보수성과 확장성에 너무 많은 시간을 사용하도록 탐의 개발 방향을 유도하여 기한내에 좀 더 다양한 기능을 만드는 시도를 못하게 했음.
