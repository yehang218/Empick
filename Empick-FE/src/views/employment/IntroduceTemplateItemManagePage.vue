<template>
  <div class="template-item-manage-container">
    <div class="content-wrapper">
      <div class="page-header">
        <h1 class="page-title">자기소개서 템플릿 항목 관리</h1>
        <p class="page-subtitle">채용에 사용할 템플릿 항목을 관리합니다</p>
      </div>
        ...
        <div class="form-section">
          ...
          <div class="add-item-container">
            <div class="input-group">
              <v-text-field v-model="newContent" label="새 템플릿 항목 내용" variant="outlined" class="form-field"
              ...
              <v-btn color="primary" variant="elevated" prepend-icon="mdi-plus" @click="showAddModal"
                :disabled="!newContent.trim() || addingItem" :loading="addingItem" class="add-btn">
                추가하기
              </v-btn>
            </div>
          </div>
            ...
            <div v-if="items && items.length > 0" class="items-list">
              <div v-for="(item, index) in items" :key="item.id" class="item-card">
                <div class="item-content">
                  ...
                  <v-btn icon size="small" color="error" variant="text" @click="showDeleteModal(item.id, item.title)"
                    class="delete-btn">
      ...
      <div class="action-buttons">
        <v-btn color="primary" @click="goToCreateTemplate" size="large" class="create-btn">
