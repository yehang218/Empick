INSERT INTO role (id, code, name, role_type, description, created_at, updated_at, deleted_at)
VALUES (1, 'ROLE_HR_ACCESS', '인사팀기능접근', 0, '인사팀 전용 기능에 접근 가능
', '2025-06-03 17:16:55', '2025-06-03 17:17:10', NULL);

INSERT INTO role (id, code, name, role_type, description, created_at, updated_at, deleted_at)
VALUES (2, 'ROLE_RECRUITMENT_PLAN_EDITOR', '채용계획서작성
', 3, '채용계획서 작성 기능에 접근 가능
...
INSERT INTO role (id, code, name, role_type, description, created_at, updated_at, deleted_at)
VALUES (4, 'ROLE_RECRUITMENT_OPERATOR', '채용진행자', 2, '채용 관련한 모든 기능에 접근 가능
