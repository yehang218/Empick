...
public enum ResponseCode {
    ...
    EMPLOYMENT_MAIL_NO_CONTENT(false, HttpStatus.BAD_REQUEST, 2630, "메일의 내용을 입력하지 않았습니다."),
    EMPLOYMENT_MAIL_NOT_FOUND(false, HttpStatus.BAD_REQUEST, 2631, "요청한 메일을 찾을 수 없습니다."),
