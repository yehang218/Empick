...
public class JobTestEvaluationDetailDTO {
    ...
    private Integer evaluationScore;     // 최종 평가 점수 (application_job_test.evaluation_score)
    private Integer gradingTotalScore;   // 채점 총점 (application_job_test.grading_total_score)
